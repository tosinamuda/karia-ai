const Footer = () => {
  return (
    <footer className="mt-auto w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 mx-auto mt-16">
      <div className="text-center">
        ...
        <div className="mt-3">
          <p className="text-gray-500">
            ...
            <a
              ...
              href="https://github.com/tosinamuda/datafest-llm-workshop"
              target="_blank"
              rel="noreferrer"
            >
              LLM Workshop
          ...
          <p className="text-gray-500">
            ...
            <a
              className="font-semibold text-blue-600 hover:text-blue-700 dark:text-blue-500 dark:hover:text-blue-400"
              href="https://github.com/useentropy/llmkit"
              target="_blank"
              rel="noreferrer"
            >
              LLMKit
          ...
          <p className="text-gray-500">
            ©{" "}
            <a href="https://tosinamuda.com" target="_blank" rel="noreferrer">
              Tosin Amuda
            </a>
        ...
        <div className="mt-3 space-x-2">
          <a
            ...
            href="https://twitter.com/tosinamuda"
            target="_blank"
            rel="noreferrer"
          >
            <svg
